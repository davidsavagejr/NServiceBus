namespace NServiceBus
{
    ...
    public static class IncomingContextExtensions
    {
        ...
        public static void SetPublicReceiveAddress(this BootstrapContext context, string address)
        {
        ...
        /// </summary>
        /// <param name="context"></param>
        public static string PublicReceiveAddress(this BootstrapContext context)
        {
